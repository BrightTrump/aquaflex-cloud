...
<head>
    ...
    <title>Create Account | AquaFlex</title>
    ...
    <section style="background-image: url('/assets/images/login-background.jpg')"
        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto">
            <a href="/" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                <img class="w-[9rem] mr-2 mt-10" src="/assets/images/Logo/aquaflex-white.png" alt="logo">
            </a>
            <div
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('register') }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="name"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm placeholder:italic focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="eg: Jolly Paul" required="">
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 text-sm">
                                    <label for="remember" class="text-gray-500 dark:text-gray-300">I agree with the
                                        <span>Terms & Conditions</span></label>
                                </div>
                            </div>
                        </div>
                        <button type="submit"
                            class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign
                            in</button>
