<x-app-layout :title="'Management'">
    ...
    <div class="grid grid-cols-3 gap-8">
        <div class="flex items-center justify-between p-10 bg-white rounded-lg border border-gray-150">
            <div class="flex flex-col gap-3">
                <h1 class="text-2xl">Total Sells</h1>
                <h2 class="text-3xl font-semibold tracking-tight">NGN @money($totalSale)</h2>
            </div>
            <span class="flex rounded-full border border-sky-500 h-24 w-24 justify-center items-center"><svg
                    xmlns="http://www.w3.org/2000/svg" width="30.359" height="30.366" viewBox="0 0 30.359 30.366">
                    <g id="Group_69" data-name="Group 69" transform="translate(-242.991 -23.995)">
                        <path id="Path_244" data-name="Path 244"
                            ...
                            transform="translate(0 -137.466)" fill="#0ea5e9"></path>
                        <path id="Path_245" data-name="Path 245"
                            ...
                            transform="translate(-68.751 0)" fill="#0ea5e9"></path>
                        <path id="Path_246" data-name="Path 246"
                            d="M338.739,264.607c-.144-.236-.43-.5-.392-.7a.836.836,0,0,1,.6-.519c.156-.017.494.352.5.552,0,.225-.281.452-.44.679Z"
                            transform="translate(-84.043 -210.998)" fill="#0ea5e9"></path>
                    </g>
                </svg></span>
        </div>
        <div class="flex items-center p-10 justify-between bg-white rounded-lg border border-gray-150">
            <div class="flex flex-col gap-3">
                <h1 class="text-2xl">Total Orders</h1>
                <h2 class="text-3xl font-semibold tracking-tight">NGN @money($totalOrder)</h2>
            </div>
            <span class="flex rounded-full border border-rose-400 h-24 w-24 justify-center items-center">
                <svg class="sherah-color2__fill" xmlns="http://www.w3.org/2000/svg" width="26.672" height="30.636"
                    ...
                    <g id="Group_70" data-name="Group 70" transform="translate(-272.518 -5.918)">
                        ...
                        <path id="Path_252" data-name="Path 252"
                            ...
                            transform="translate(-66.652 -117.042)" fill="#fb7185" />
                    </g>
                </svg>
            </span>
        </div>
        <div class="flex items-center p-10 justify-between bg-white rounded-lg border border-gray-150">
            <div class="flex flex-col gap-3">
                <h1 class="text-2xl">Total Customer</h1>
                <h2 class="text-3xl font-semibold tracking-tight">{{count((array)$customer)}}</h2>
            </div>
            <span class="flex rounded-full border border-yellow-400 h-24 w-24 justify-center items-center">
                <svg class="sherah-color1__fill" xmlns="http://www.w3.org/2000/svg" width="35.176" height="30.636"
                    ...
                    <g id="Group_1177" data-name="Group 1177" transform="translate(-207.977 -44.521)">
                        <path id="Path_253" data-name="Path 253"
                            ...
                            transform="translate(0 -89.312)" fill="#facc15" />
                        <path id="Path_254" data-name="Path 254"
                            ...
                            transform="translate(-72.929 0)" fill="#facc15"/>
                        <path id="Path_255" data-name="Path 255"
                            ...
                            transform="translate(-10.849 -27.636)" fill="#facc15"/>
                        <path id="Path_256" data-name="Path 256"
                            ...
                            transform="translate(-162.683 -27.637)" fill="#facc15" />
                    </g>
                </svg>
            </span>
        </div>
