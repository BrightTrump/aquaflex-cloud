                                    ...
                                    <div class="sherah-header__right">
                                        ...
                                        <div class="sherah-dark-light">
                                            <button id="sherah-dark-light-button">
                                                <svg class="sherah-offset__fill" xmlns="http://www.w3.org/2000/svg"
                                                    width="26.536" height="26" viewBox="0 0 26.536 26">
                                        ...
                                        <div class="sherah-header__zoom">
                                            <button id="sherah-header__full">
                                                <svg class="sherah-offset__fill" xmlns="http://www.w3.org/2000/svg"
                                                    width="33.674" height="26" viewBox="0 0 33.674 26">
                                        ...
                                        <div class="sherah-header__dropmenu">
                                            <svg class="sherah-offset__fill" id="Icon"
                                                xmlns="http://www.w3.org/2000/svg" width="22.875" height="25.355"
                                            ...
                                            <div class="sherah-dropdown-card sherah-dropdown-card__alarm sherah-border">
                                                <svg class="sherah-dropdown-arrow" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <path id="Path_1271" data-name="Path 1271"
                                                        ...
                                                        transform="translate(15384.189 -7175.73)" stroke-width="1" />
                                                </svg>
                                                <h3 class="sherah-dropdown-card__title sherah-border-btm">
                                                    Recent
                                                    Notification</h3>
                                                ...
                                                <ul class="sherah-dropdown-card_list">
                                                    <li>
                                                        <div class="sherah-paymentm__name">
                                                            <div
                                                                class="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--5">
                                                            ...
                                                            <div class="sherah-paymentm__content">
                                                                <h4 class="sherah-notifications__title">You
                                                                    have
                                                                    an offer! <span>successfully done</span>
                                                                </h4>
                                                                <p
                                                                    class="sherah-paymentm__text sherah-paymentm__text--notify">
                                                                    20 minutes ago</p>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="sherah-paymentm__name">
                                                            <div
                                                                class="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="17.272"
                                                                    height="17.272" viewBox="0 0 17.272 17.272">
                                                            ...
                                                            <div class="sherah-paymentm__content">
                                                                <h4 class="sherah-notifications__title">You
                                                                    upload your fast product <span>successfully
                                                                        done</span></h4>
                                                                <p
                                                                    class="sherah-paymentm__text sherah-paymentm__text--notify">
                                                                    3 hours ago </p>
                                                    ...
                                                    <li>
                                                        <div class="sherah-paymentm__name">
                                                            <div
                                                                class="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--3">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="17.723"
                                                                    height="15.196" viewBox="0 0 17.723 15.196">
                                                            ...
                                                            <div class="sherah-paymentm__content">
                                                                <h4 class="sherah-notifications__title">Your
                                                                    Account has been created <span>successfully
                                                                        done</span></h4>
                                                                <p
                                                                    class="sherah-paymentm__text sherah-paymentm__text--notify">
                                                                    5 hours ago</p>
                                                    ...
                                                    <li>
                                                        <div class="sherah-paymentm__name">
                                                            <div
                                                                class="sherah-paymentm__icon sherah-paymentm__icon--notify ntfmax__bgc--4">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="15.964"
                                                                    height="21.016" viewBox="0 0 15.964 21.016">
                                                            ...
                                                            <div class="sherah-paymentm__content">
                                                                <h4 class="sherah-notifications__title">Thank
                                                                    you !you made your fast sell
                                                                    <span>$120</span>
                                                                </h4>
                                                                <p
                                                                    class="sherah-paymentm__text sherah-paymentm__text--notify">
                                                ...
                                                <div class="sherah-dropdown-card__button"><a href="notifications.html"
                                                        class="sherah-dropdown-card__sell-all">See all
                                                        Notification</a></div>
                                            </div>
                                        ...
                                        <div class="sherah-header__author sherah-flex__center--top">
                                            <div class="sherah-header__author-img">
                                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45"
                                                    height="45" viewBox="0,0,256,256">
                                                    <g fill="#44474C" fill-rule="nonzero" stroke="none"
                                                        ...
                                                        <g transform="scale(8,8)">
                                                            <path
                                                                d="M16,3c-7.16797,0 -13,5.83203 -13,13c0,7.16797 5.83203,13 13,13c7.16797,0 13,-5.83203 13,-13c0,-7.16797 -5.83203,-13 -13,-13zM16,5c6.08594,0 11,4.91406 11,11c0,6.08594 -4.91406,11 -11,11c-6.08594,0 -11,-4.91406 -11,-11c0,-6.08594 4.91406,-11 11,-11zM16,8c-2.75,0 -5,2.25 -5,5c0,1.51563 0.70703,2.86328 1.78125,3.78125c-2.25,1.16797 -3.78125,3.51953 -3.78125,6.21875h2c0,-2.77344 2.22656,-5 5,-5c2.77344,0 5,2.22656 5,5h2c0,-2.69922 -1.53125,-5.05078 -3.78125,-6.21875c1.07422,-0.91797 1.78125,-2.26562 1.78125,-3.78125c0,-2.75 -2.25,-5 -5,-5zM16,10c1.66797,0 3,1.33203 3,3c0,1.66797 -1.33203,3 -3,3c-1.66797,0 -3,-1.33203 -3,-3c0,-1.66797 1.33203,-3 3,-3z">
                                                            </path>
                                                        </g>
                                                    </g>
                                                </svg>
                                            ...
                                            <div class="sherah-header__author--info sherah-dflex sherah-dflex__base">
                                                <h4
                                                    ...
                                                    {{ Auth::user()->name }} <span
                                                        class="sherah-header__author--text">{{ Auth::user()->role }}</span>
                                                </h4>
                                                    ...
                                                    <li>
                                                        <div class="sherah-dropdown-card-info">
                                                            ...
                                                            <h4 class="sherah-dropdown-card-name"><a
                                                                    href="profile-info.html">My Profile</a>
                                                            </h4>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <form method="POST" action="{{ route('logout') }}">
                                                            ...
                                                            <div class="sherah-dropdown-card-info">
                                                                ...
                                                                <h4 class="sherah-dropdown-card-name"><a
                                                                        href="{{route('logout')}}" onclick="event.preventDefault(); this.closest('form').submit();">Logout</a></h4>
                                                            </div>
                                                        </form>
                                                    </li>
                                                </ul>
