<aside
    class="lx:flex hidden basis-[300px] h-[82vh] bg-white border border-gray-150 rounded-lg customer-sidebar sticky top-0 ">
    <ul class="w-full">
        <li>
            <a href="/management">
                <span class="">
                    <svg class="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="18.075" height="18.075"
        ...
        <li x-data="{ open: false }">
            <a href="#" @click="open = !open">
                <span class="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21.136" height="17.873"
                ...
                </span>Products <i x-show="!open" class="fas fa-angle-right text-xl"></i><i x-show="open" class="fas fa-angle-down text-xl"></i></a>
                <ul class="pl-14 bg-transparent" x-show="open" x-transition.duration.300ms @click.outside="open = false">
