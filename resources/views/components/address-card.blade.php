<div class="grid grid-cols-1 xm:grid-cols-2 xm:p-10 p-4 gap-10">
    @foreach ($userAddresses as $userAddress)
        <div class="border border-gray-150 p-5 relative">
            <a href="{{route('address.edit', $userAddress->address->id)}}" class="flex absolute right-5 top-5 text-md font-medium border border-primary-500 py-2 px-4 text-primary-500">Edit</a>
